...
```javascript
import sfillEqual from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-sfill-equal@esm/index.mjs';
```
...
[@stdlib/blas/ext/base/sfill-nan]: https://github.com/stdlib-js/blas-ext-base-sfill-nan/tree/esm
